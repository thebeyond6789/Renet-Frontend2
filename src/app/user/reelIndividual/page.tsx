      ...
      <div id="containerReels">
        <div className="childReels">
          <div className="item" onClick={clickHienDetailreels}>
            ...
            <span>
              <i className="bi bi-play-fill"></i>1000 N
            </span>
          </div>
          <div className="item">
            <video>
          ...
          <div className="item">
            ...
            <div className="contentTitle">
              ...
              <a className="titlePost" href="#">
                <label>Hoàng Tôn</label> Hello(title) helo helo helo helo helo
                helo helo helo helo helo helo helohelo helo helo😒😒😒
              </a>
            </div>
